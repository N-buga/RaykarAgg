...
from generate_data import generate_model_points, generate_points, generate_DS_points
import numpy as np


class TestGens(unittest.TestCase):
    def check_generation(self, x, y, w, alpha, beta, y_real, l, acc, mu_exact_const, mu_ans_const):
        em_ds_raykar = EM_DS_Raykar(x, y, y_real=None, l=l)
    ...
    def test_raykar_gen(self):
        ...
        self.check_generation(x, y, w, alpha, beta, y_real, 1, acc=1e-2, mu_exact_const=0.95, mu_ans_const=0.99)

    # def test_raykar_gen2(self):
    #     x, y, y_real, y_all, alpha, beta, w, mu = generate_points(50000, 5, 6, 1)
    #
    #     self.check_generation(x, y, w, alpha, beta, y_real, 1)
    ...
    def test_DS_gen(self):
        ...
        self.check_generation(x, y, None, alpha, beta, y_real, 0, acc=2e-2, mu_exact_const=0.75, mu_ans_const=0.95)
